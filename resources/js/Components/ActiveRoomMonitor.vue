      ...
      >
        ...
        <div class="text-xs mb-3 px-3 py-2 rounded-lg" style="background:#12121a;">
          ...
          <div class="flex justify-between mt-1">
            ...
            <span class="text-white">{{ new Date(rental.started_at).toLocaleTimeString('id-ID', {hour:'2-digit', minute:'2-digit'}) }}</span>
          </div>
        </div>
        ...
        <div class="flex items-center justify-between mb-3">
          <span class="text-xs" style="color:#94a3b8;">Total Sementara</span>
